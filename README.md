...
- Average employee age is 37, indicating a mid-career workforce
- ## Dashboard Features
- Total headcount with gender split (Male 60% / Female 40%)
- Active vs inactive employee count
- Promotion pipeline tracker (Due vs Not Due)
- Service year distribution
- Job level breakdown (Level 1 to Level 5)
- Employee distance from office
- Education field distribution
- ## Dashboard Preview
  <img width="607" height="340" alt="HR-Performance-Dashboard" src="https://github.com/user-attachments/assets/9b96ed1e-9fa3-4a44-90d6-9b181bf770e1" />
